                            ...
                            <li class="countries-item">
                                ...
                                <div>
                                    <div class="list-icon-function">
                                        <div class="item edit">
                                            <a href="#" class="text-success" wire:click="edit({{ $room->id }})"><i class="icon-edit-3"></i></a>
                                        </div>
                            ...
                            <div>
                                <form wire:submit.prevent="save">
                                    ...
                                    <fieldset class="email mb-24">
                                        <div class="body-title mb-10">Details <span class="tf-color-1">*</span></div>
                                        <input type="text" wire:model="details" placeholder="Description" required>
                                    </fieldset>
                                    <fieldset class="email mb-24">
                                        <div class="body-title mb-10">Room Category <span class="tf-color-1">*</span></div>

                                        <div class="select">
                                            <select class="" wire:model="room_category_id" required>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="update({{$room_id}})" class="p-5">
                        <fieldset class="name mb-24">
                            <div class="body-title mb-10">Title <span class="tf-color-1">*</span></div>
                            <input type="text" wire:model="title" placeholder="Title" required>
                        </fieldset>
                        ...
                        <fieldset class="email mb-24">
                            ...
                            <div class="select">
                                <select class="" wire:model="room_category_id" required>
                                    <option selected>Choose category</option>
                                    @foreach ($categories as $category)
                                    <option @if($category->id == $room_category_id) selected @endif value="{{ $category->id }}">{{ $category->category_title }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </fieldset>
